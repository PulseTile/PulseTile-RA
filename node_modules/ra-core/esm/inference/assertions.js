...
export var isNumeric = function (value) { return !isNaN(parseFloat(value)) && isFinite(value); };
...
export var isDateString = function (value) {
    return typeof value === 'string' && !isNaN(parseDate(value));
};
export var valuesAreDateString = function (values) { return values.every(isDateString); };
