 ...
 * </ReferenceArrayInput>
 */
var ReferenceArrayInputController = /** @class */ (function (_super) {
    __extends(ReferenceArrayInputController, _super);
    ...
    ReferenceArrayInputController.prototype.componentDidMount = function () {
        this.fetchReferencesAndOptions();
    };
    ReferenceArrayInputController.prototype.componentWillReceiveProps = function (nextProps) {
    ...
    ReferenceArrayInputController.prototype.fetchReferencesAndOptions = function (nextProps) {
        this.fetchReferences(nextProps);
        this.fetchOptions(nextProps);
    };
    ReferenceArrayInputController.prototype.render = function () {
...
exports.ReferenceArrayInputController = ReferenceArrayInputController;
ReferenceArrayInputController.propTypes = {
    ...
    crudGetMatching: prop_types_1.default.func.isRequired,
    crudGetMany: prop_types_1.default.func.isRequired,
    ...
    matchingReferences: prop_types_1.default.oneOfType([
    ...
    referenceRecords: prop_types_1.default.array,
    referenceSource: prop_types_1.default.func.isRequired,
...
var EnhancedReferenceArrayInputController = compose_1.default(translate_1.default, react_redux_1.connect(makeMapStateToProps(), {
