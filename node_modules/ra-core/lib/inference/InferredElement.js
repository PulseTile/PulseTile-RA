...
var InferredElement = /** @class */ (function () {
    ...
    InferredElement.prototype.getElement = function (props) {
        ...
        return this.children
            ? react_1.createElement(this.type.component, __assign({}, this.props, props), this.children.length > 0
                ? this.children.map(function (child, index) {
                    return child.getElement({ key: index });
                })
                : this.children.getElement())
            : react_1.createElement(this.type.component, __assign({}, this.props, props));
    };
