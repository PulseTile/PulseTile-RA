...
exports.isNumeric = function (value) { return !isNaN(parseFloat(value)) && isFinite(value); };
...
exports.isDateString = function (value) {
    return typeof value === 'string' && !isNaN(parse_1.default(value));
};
exports.valuesAreDateString = function (values) { return values.every(exports.isDateString); };
