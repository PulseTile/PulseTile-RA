...
const dummyData = [
    ...
    { cityName: "Scarborough", lat: 54.27966, lng: -0.40443, size: 30, healthScore: 74, color: COLOR_AMBER },
    { cityName: "Bridlington", lat: 54.08306, lng: -0.19192, size: 20, healthScore: 24, color: COLOR_RED },
    { cityName: "Rotherham", lat: 53.43012, lng: -1.35678, size: 30, healthScore: 72, color: COLOR_AMBER },
    { cityName: "Halifax", lat: 53.71667, lng: -1.85, size: 30, healthScore: 72, color: COLOR_AMBER },
