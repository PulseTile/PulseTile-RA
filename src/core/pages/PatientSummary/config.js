...
export const coreSynopsisData = [
    { id: "block-problems", title: "Problems / Issues", list: "problems", icon: faNotesMedical, isActive: false, },
    { id: "block-medications", title: "Medications", list: "medications", icon: faCapsules, isActive: false },
    { id: "block-allergies", title: "Allergies", list: "allergies", icon: faAllergies, isActive: false },
    { id: "block-contacts", title: "Contacts", list: "contacts", icon: faPhone, isActive: false },
];
